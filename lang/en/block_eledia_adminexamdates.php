...
$string['examtimestart'] = 'Start of the exam<br />General exam period is {$a}';
...
$string['examname_help'] =
        'Please use the following nomenclature when naming the exam: "YYYYMMDD Department examiner/lecturer free text". Example: "20230731 FB08 Mustermann Physiology Basics".';
...
$string['examiner_help'] =
        'Select one or more instructors from the list. The input of lecturers names that are not in the list will not be accepted.';
...
$string['config_examrooms'] =
        'Each line configures its own room. In each line there is first a unique room ID (e.g. \'PR1\'), followed by the name of the room (e.g. \'Examination room 1\'), as well as the room capacity, i.e. the maximum number of participants (e.g. \'100\') and the displayed room color (e.g. \'#3F51B5\'), separated by a vertical line.';
$string['examrooms'] = 'Configuration of the examination rooms';
$string['config_responsiblepersons'] =
        'List of the user IDs of those responsible for the E-Assessment-Center, each separated by a comma. (e.g. \'2,4,5,12\')';
...
$string['configreloaddepartments'] =
        'Please select here after changes in the course categories of the departments in the e-exam system - the above selection field "Selection of departments" will be updated after the settings have been saved.';
$string['setting_envcategoryidnumber'] = 'Course category ID of "Exam Environment"';
$string['config_envcategoryidnumber'] =
        'The departments are located as sub-categories in the "Exam Environment" of the e-exam system. This course category ID should be set in the "Exam Environment" category.';
$string['setting_archivecategoryidnumber'] = 'Course category ID of the exam archive';
$string['config_archivecategoryidnumber'] =
        'The canceled exam courses are archived in a course category of the e-exam system. This course category ID should be set in the corresponding archive course category.';
...
$string['confirm_delete_singleexamdate_msg'] =
        'Do you really want to delete for the exam "{$a->name}" the {$a->index}. single exam date?';
...
$string['error_startexamtime'] =
        'The earliest possible exam date is {$a->start}. The latest possible time for the completion of an exam is {$a->end}.';
...
$string['config_bordercolor_unconfirmed_dates'] =
        'Border color value for unconfirmed dates the calendar view of exam dates admins.';
$string['setting_bordercolor_unavailable_dates'] = 'Border color 2';
$string['config_bordercolor_unavailable_dates'] =
        'Border color value for unavailable dates in the calendar view of exam dates manager.';
$string['config_holidays'] =
        'Each line configures a holiday. In each line there is first a date (e.g. \'01.05.2023\'), followed by the name of the holiday (e.g. \'Tag der Arbeit\'), separated by a vertical line.';
...
$string['config_examinercohorts'] =
        'Users who are in these cohorts will be available in the examiner selection in the exam date form.';
