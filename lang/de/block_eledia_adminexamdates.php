...
$string['config_responsiblepersons'] =
        'Liste der User-IDs der E-Assessment-Center Verantwortlichen, getrennt jeweils durch ein Komma. (Beispiel: \'2,4,5,12\')';
...
$string['configreloaddepartments'] =
        'Bitte hier auswählen nach Änderungen der Kurskategorien der Fachbereiche im Prüfungssystem - das obige Auswahlfeld "Auswahl der Fachbereiche" wird nach dem Speichern der Einstellungen aktualisiert.';
$string['setting_envcategoryidnumber'] = 'Kursbereichs-ID der Prüfungsumgebung';
$string['config_envcategoryidnumber'] =
        'Die Fachbereiche liegen als Unterkategorien in der "Prüfungsumgebung" des Prüfungssystems. Diese Kurskategorie-ID sollte in der Kategorie "Prüfungsumgebung" gesetzt sein.';
$string['setting_archivecategoryidnumber'] = 'Kursbereichs-ID des Prüfungsarchivs';
$string['config_archivecategoryidnumber'] =
        'Die stornierten Prüfungskurse werden in einer Kurskategorie des Prüfungssystems archiviert. Diese Kurskategorie-ID sollte in der entsprechenden Archiv-Kurskategorie gesetzt werden.';
...
$string['eledia_adminexamdates:confirmexamdates'] =
        'Bestätigen der E-Prüfungs Termine im eLeDia E-Prüfung Termin-Verwaltungs-Block';
...
$string['error_startexamtime'] =
        'Der frühestmögliche Prüfungstermin ist {$a->start} Uhr. Der spätestmögliche Zeitpunkt für die Beendigung einer Prüfung ist {$a->end} Uhr.';
...
$string['error_wrong_email'] =
        'Bitte geben Sie eine korrekte E-Mail-Adresse mit der Eingabetaste ein - oder suchen Sie in der Auswahl!';
...
$string['config_bordercolor_unconfirmed_dates'] =
        'Rahmenfarbe für unbestätigte Termine in der Kalenderansicht der Prüfungstermin-Admins.';
$string['setting_bordercolor_unavailable_dates'] = 'Rahmenfarbe 2';
$string['config_bordercolor_unavailable_dates'] =
        'Rahmenfarbe für nicht verfügbare Termine in der Kalenderansicht des Prüfungsterminmanagers.';
$string['config_holidays'] =
        'Jede Zeile konfiguriert einen Feiertag. In jeder Zeile steht zuerst ein Datum (z. B. \'01.05.2023\'), gefolgt vom Namen des Feiertags (z.B. \'Tag der Arbeit\'), getrennt durch einen senkrechten Strich.';
...
$string['modal_body_holiday_not_available'] =
        'Termine an Feiertagen sind nicht möglich. Bitte suchen Sie sich einen anderen Termin!';
$string['modal_title_past_not_available'] = 'Vergangenheit';
$string['modal_body_past_not_available'] =
        'Termine in der Vergangenheit sind nicht möglich. Bitte suchen Sie sich einen anderen Termin!';
...
$string['config_examinercohorts'] =
        'Nutzer die in diesen Globale Gruppen sind, stehen in der Auswahl der Prüfer:in des Prüfungsterminformulars zur Verfügung.';
$string['setting_instanceofmodelediachecklist'] = 'Aktivität eLeDia Checklist';
$string['config_instanceofmodelediachecklist'] =
        'Auswahl einer Instanz der Aktivität eLeDia Checklist, die als Checkliste verlinkt ist.';
...
$string['progressbar_confirmed_course_create'] =
        'Bestätigung des Prüfungstermins - Erstellung eines Kurses auf dem Prüfungssystem.';
$string['progressbar_confirmed_email'] =
        'Bestätigung des Prüfungstermins - Versand E-Mail an den Ansprechpartner und das Prüfungsteam.';
